                 ...
                 ?>
                     <tr class="odd gradeX" align="center">
                         ...
                         while ($row = mysql_fetch_array($row_tv)) {?>
                              <a data-id="<?php $id= $row_hd["ID_TV"];?>" href="danhsachhd.php?p=showinfo&ID_TV={{ID_TV}}" data-toggle='modal' data-remote-target="#myModal .modal-body" >  <?php if($row_hd["ID_TV"]== $row["ID_TV"]) echo $row["TEN"] ?></a>
